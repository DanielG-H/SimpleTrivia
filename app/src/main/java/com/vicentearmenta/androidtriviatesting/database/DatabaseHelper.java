...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String seedQuestionTable = " INSERT INTO " + TABLE_QUESTION + " (" + COLUMN_QT_ID + ", "
                ...
                "(4, 'What is the name of the talking dog?', 4)," +
        ...
        String seedAnswerTable = " INSERT INTO " + TABLE_ANSWER + " (" + COLUMN_AW_ID + ", " +
                ...
                "(13, 'The Good Dinasour')," +
                "(14, 'Emperor Zurg')," +
                "(15, 'Waste Allocation Load Lifter- Earth');";

        sqLiteDatabase.execSQL(createQuestionTable);
        sqLiteDatabase.execSQL(createAnswerTable);
        sqLiteDatabase.execSQL(createResultTable);

        sqLiteDatabase.execSQL(seedQuestionTable);
        sqLiteDatabase.execSQL(seedAnswerTable);
    }
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        sqLiteDatabase.execSQL(deleteQuestionTable);
        sqLiteDatabase.execSQL(deleteAnswerTable);
